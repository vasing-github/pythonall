...
def insert(info1,shouru,name,huji,changzhu,zhuanyi,lianxidianhua,zhuanyitype,zhuanyihangye,wenhuachengdu):
    ...
    data = {
        ...
        "aac011": wenhuachengdu,  # 文化程度 10研究生以上 11博士  14硕士 21本科  31专科 41中等 44高中 47技工 61普通中学  71初级中学 81小学 90其他
    ...
    "acc455": "2",  # 转移就业方式 1政府组织转移  2自发转移  3企业组织  5就业扶贫车间  6农村劳务 7其他
        # "aab004": info1['aab004'],
        # "acc454": info1['acc454'],
        "acc457": zhuanyihangye, # 转移行业 C351：采矿 E47：建筑业  G59：仓储 C372：城市轨道交通设备制造  O80：居民服务  F51：批发业  I65：计算机  C41：其他制造业 H62：餐饮
        "acc452": zhuanyitype, #转移就业产业类别 1:一产业  2：二产业  3： 三产业
        "acc328": shouru,  # 月收入  9不详  7：12000-20000 8：20000-25000  0：1000以下  1：1000-2000  2：2000-3000 3：3000-4000 4：4000-5000  5：5000-8000 6：8000以上
        "aab301Desc": zhuanyi,
        # "aae013": info1['aae013'],
        "cc55Jsonstr": "[]",
        # "aac180": info1['aac180'],
...
def readexcel():
    ...
    for row in df.itertuples(index=False):
        ...
        wenhuachengdu = getattr(row,"文化程度")
        # print(f'列名1: {value1}, 列名2: {value2}')
        info1 = getinfo1(idcard)
        print(name)
        time.sleep(2)
        insert(info1,shouru,name,huji,changzhu,zhuanyi,lianxidianhua,zhuanyitype,zhuanyihangye,wenhuachengdu)
        time.sleep(2)


cookie = 'SESSION=YWE2YmIyMTktNjYwNC00MjdjLTljM2YtYzdhMmQwYzk5MzJl; BIGipServer10.160.7.100:8000=1108516874.12661.0000'
