...
os.environ['QT_QPA_PLATFORM_PLUGIN_PATH'] = os.environ['QT_QPA_PLATFORM_PLUGIN_PATH'] = os.path.join(base_path, 'Lib', 'site-packages', 'PyQt5', 'Qt5', 'plugins')
print(base_path)
...
if __name__ == '__main__':
    import PyInstaller.utils.hooks.qt as qt_hooks

    # 替换Qt plugin目录的路径
    # qt_plugins_path = r"F:\job\Lib\site-packages\PyQt5\Qt5\plugins"
    # qt_hooks.qt_plugins_dir = qt_plugins_path
