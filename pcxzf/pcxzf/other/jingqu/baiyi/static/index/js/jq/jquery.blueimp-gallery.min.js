	...
	return a.extend(d.prototype, {
		...
		loadAPI: function() {
			var a, b = this,
				...
				d = "//www.sckingshi.com/iframe_api",
		...
		textFactory: function(a, b) {
			...
			return f ? (void 0 === this.getItemProperty(a, e.urlProperty) && (a[e.urlProperty] = "//www.sckingshi.com/watch?v=" + f), void 0 === this.getItemProperty(a, e.videoPosterProperty) && (a[e.videoPosterProperty] = "//img.sckingshi.com/vi/" + f + "/maxresdefault.jpg"), this.videoFactory(a, b, new d(f, e.youTubePlayerVars, e.youTubeClickToPlay))) : c.call(this, a, b)
		}
	}), b
}),
function(a) {
