...
up_time_conf = {'机关简介': 365, '政府工作报告': 365, '规划计划': 365, '政策': 365, '统计信息': 90, '行政权力': 90, '预算/决算': 365, '收费项目': 365,
                '政府采购': 180, '重大项目': 90, '重大民生信息': 90, '其他法定信息': 90, '教育科技': 90, '养老服务': 60, '社会救助': 90, '就业创业': 60,
                '社会保障': 60, '招考录用': 180, '司法监督': 90, '价格信息': 90, '住房保障': 60, '涉农补贴': 60, '农产品价格监测': 60, '应急管理': 60,
                '监测预警': 90, '审计监督': 90, '市场监管': 60, '环评公示': 60, '环保督察': 60, '环境质量公报': 60, '执法检查': 60, '乡村振兴': 90,
                '行政许可/处罚': 90, '医疗保障': 90, '教育科技': 60, '公共文化服务': 90, '放管服改革': 60, '卫生健康': 60, '价格监测': 60, '民生保障': 90}
