...
bumen_phone = {'平昌县人民政府办公室': [("17311067255", "吴晓龙")], '平昌县发展和改革局': [("15328278750", "龙寿林"), ("13547305868", "周良建")],
               ...
               '平昌县白衣镇人民政府': [("18728717171", "吴  飞"),  ("18728779888", "谭东平"), ("18080505041", "李洪科"), ("13778453871", "刘星"), ("15351427816", "李麒麟"), ("18482175479", "杜秋燕"), ("13350239527", "李金隆"), ("18282138379", "付小娟"), ("18382822292", "陈嘉伟"), ("13458333904", "唐东辉"), ("13909006932", "陈于怀"), ("15982785899", "王美全"), ("18113764079", "雷枭"), ("17781919082", "魏龙泉"), ("18382702151", "杨钊"), ("18282243785", "姜媛")],
               ...
               '平昌县龙岗镇人民政府': [("13881655966", "李越翰"), ("13568469092", "杨    波"), ("18981667735", "李天志"), ("13568481648", "李    奎"), ("13550494391", "杜华强"), ("18282116399", "王青松"), ("13778779876", "李    露"), ("18728765309", "文联华"), ("13219298355", "李东明"), ("18382785578", "金    雄"), ("13550498768", "刘    勇"), ("18728789825", "吴泽军"), ("15881750821", "何    玲"), ("18382885974", "袁    芹")],
               '平昌县土垭镇人民政府': [("13981661300", "李佳平"), ("13699443727", "李宏标")],
               '平昌县佛楼镇人民政府': [("18090203188", "李世伟"), ("18582555832", "何宗庚")],
               '平昌县响滩镇人民政府': [("13541774000", "熊志军"), ("15282766786", "杨永富"), ("13882401777", "鲜新明"), ("18728728889", "阙    毅"), ("13981661499", "胡成国"), ("15775753798", "黄    梅"), ("15775730877", "张晓东"), ("18398256506", "吴    杰"), ("13990047366", "邓鲲鹏"), ("18382892891", "李晋安"), ("17738543077", "任奕锋"), ("15282765395", "王心泉"), ("15982759521", "李    兵"), ("18398989378", "曾爱辉"), ("15760176652", "李清川"), ("17808324584", "王  涛"), ("13340630724", "钱宇飞")],
               '平昌县大寨镇人民政府': [("13350476357", "张海钦"), ("15082708793", "杨  雄")],
               '平昌县驷马镇人民政府': [("13551793088", "夏照祥"), ("19983658665", "吴攀宇"), ("13778775206", "杜华山"), ("13795931001", "曾晗"), ("18282787267", "杨璧瑜"), ("15228562554", "王劲松")],
               ...
               '平昌县得胜镇人民政府': [("18111339665", "李生荣"), ("19983609902", "赵晓艳"), ("13795931656", "牟强"), ("15282768275", "何红琼"), ("15282751112", "张红胜"), ("13678276798", "苟大军"), ("18030951745", "潘俊铖"), ("13551493198", "刘浩"), ("18980297293", "何尧"), ("13568484746", "谭利民"), ("18111330950", "李超平"), ("18482775855", "魏俊华"), ("18398937399", "汪久淳"), ("15760553619", "赵   苗"), ("13730831476", "张钰杉"), ("17738552464", "韩官伦")],
               ...
               '平昌县三十二梁镇人民政府': [("19960155959", "马宏秋"), ("18682780268", "戚红锐"), ("15196546622", "李    布"), ("18228875517", "袁明森"), ("13989159911", "沈忠华"), ("13550499296", "何    军"), ("15983991253", "沈永鹏"), ("18599926336", "杨    朕"), ("18095025138", "杨长林"), ("18281828280", "何俊良"), ("13982591818", "李小雨"), ("18382775537", "陈雯雯"), ("18090251082", "蒲    琪"), ("18096359062", "杨    超"), ("18121939328", "杜    磊"), ("13980779817", "程    西")],
...
up_time_conf = {'机关简介': 355, '政府工作报告': 355, '规划计划': 355, '政策': 355, '统计信息': 80, '行政权力': 80, '预算/决算': 355, '收费项目': 355,
                '政府采购': 180, '重大项目': 80, '重大民生信息': 80, '其他法定信息': 80, '教育科技': 80, '养老服务': 60, '社会救助': 80, '就业创业': 60,
                '社会保障': 60, '招考录用': 180, '司法监督': 80, '价格信息': 80, '住房保障': 60, '涉农补贴': 60, '农产品价格监测': 60, '应急管理': 60,
                '监测预警': 80,  '市场监管': 60, '环评公示': 60, '环保督察': 60, '环境质量公报': 60, '执法检查': 60, '乡村振兴': 80,
                '行政许可/处罚': 80, '医疗保障': 80, '教育科技': 60, '公共文化服务': 80,  '卫生健康': 60, '价格监测': 60, '民生保障': 80}

# 基层政务公开领域和负责单位映射
jczwgk_area_comp_dic = {'公共文化服务': '平昌县文化广播电视体育和旅游局', '就业领域': '平昌县人力资源和社会保障局', '涉农补贴': '平昌县农业农村局', '食品药品': '平昌县市场监督管理局',
                        '社会救助': '平昌县民政局', '卫生健康': '平昌县卫生健康局', '养老服务': '平昌县民政局', '义务教育': '平昌县教育科技局', '公共法律': '平昌县司法局',
                        ...
                        '统计领域': '平昌县统计局', '公共资源交易': '县公共资源交易服务中心', '交通运输': '平昌县交通运输局', '扶贫领域': '平昌县农业农村局',
