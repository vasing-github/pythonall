...
def uploadfile(jid, bz_gov_id, file_name, path_excel, parent_t, article_t, content_id):
    ...
    headers = {
        ...
        'Referer': 'http://10.15.3.133:'+conf.jiyuehua_port+'/fileCenter/uploadPage?uploadType=1&s=0.1754363371550416&isOpen=true&_=1722305351088',
...
if __name__ == '__main__':
    ...
    file_path = r'G:\project\python\pcxzf\pcxzf\bazhouqu\kaipumodify\modifyfile\rBUtIWMWnOqASU0IAAB_qamoW1E80.docx'
    wrong = '挡案'
    right = '档案'
    doc = Document(file_path)
    ...
    # 假设你的列表是这样的
    # 假设你的列表是这样的
    # file_path = r'E:\project\python\pythonall\pcxzf\pcxzf\bazhouqu\kaipumodify\modifyfile\rBUtIWMWnOqASU0IAAB_qamoW1E80.docx'
